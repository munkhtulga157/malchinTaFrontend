...
import DeleteMissingModal from "./DeleteMissingModal";
import UserMissingModal from "./UserMissingModal";
import BackgroundImage from "../configs/BackgroundImage";
import Loading from "../configs/Loading";

export default function UserMissing({ navigation }) {
  ...
  const handleMissing = (photo, title, description, date) => {
  ...
  const handleAdd = () => {
    navigation.navigate("AddMissing");
  };
